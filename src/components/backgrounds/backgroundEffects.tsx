    ...
    <div className="pointer-events-none fixed inset-0 -z-10 flex h-screen w-screen justify-center overflow-hidden">
      ...
      <div
        className={cn(
          ...
          'dark:bg-[radial-gradient(50%_100%_at_50%_100%,--theme(--color-teal-500/0.8)_0%,--theme(--color-teal-500/0.6)_30%,--theme(--color-teal-500/0.4)_50%,--theme(--color-teal-500/0.2)_70%,transparent_100%)]',
          'blur-[140px]',
      ...
      {/* 背景漸變 */}
      <div className="absolute inset-0 bg-linear-to-t from-transparent via-cyan-200/50 to-cyan-200 opacity-80 transition-colors duration-300 dark:via-black/50 dark:to-black" />
            ...
            ? // Dark mode rain drops
              rainDrops.map((drop) => (
                <line
                  ...
                  y2={`${drop.length}%`}
                  stroke="currentColor"
                  className={cn('text-cyan-400/20 dark:text-teal-400/20', `animate-rain`)}
                  strokeWidth="1"
                  style={{
            ...
            : // Light mode floating bubbles
              bubbles.map((bubble) => (
                <circle
                  ...
                  stroke="currentColor"
                  strokeWidth="0.5"
                  className={cn('text-cyan-400/80', 'animate-float')}
                  style={{
