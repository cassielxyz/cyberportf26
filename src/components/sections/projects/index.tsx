...
export default function Projects() {
  ...
  const carouselButtonClass = cn(
    'border-cyan-300/50 bg-white/10 backdrop-blur-xs',
    'transition-colors duration-200 ease-out',
    'hover:bg-white/20 active:bg-white/30',
    'dark:-teal-/50 dark:bg-gray-800/10',
  ...
  return (
    <div className="relative mb-20 flex items-center justify-center overflow-hidden pt-header">
      ...
      >
        ...
        >
          <Code2 className="size-8 text-cyan-500 dark:-teal-" />
          <TextScramble
          ...
          {isLoading ? (
            ...
            >
              ...
              <CarouselPrevious
                ...
                variant="outline"
              >
                <ChevronLeft className="size-4 text-cyan-500 dark:-teal-" />
              </CarouselPrevious>
              <CarouselNext
                className={cn(carouselButtonClass, 'right-2 lg:-right-12')}
                variant="outline"
              >
                <ChevronRight className="size-4 text-cyan-500 dark:-teal-" />
              </CarouselNext>
            </Carousel>
          )}
        </div>
