  ...
  return (
    ...
    >
      <Card
        className={cn(
          className,
          'relative border-cyan-300/50 bg-white/10 backdrop-blur-xs dark:border-teal-900/50 dark:bg-gray-900/60',
      ...
      >
        <CardHeader className="flex flex-none flex-row items-start justify-between space-y-0 pb-2">
          ...
          <div className="size-10 shrink-0 overflow-hidden rounded-full border-2 border-cyan-300/50 dark:border-teal-700/50">
            ...
            <div className="flex flex-wrap gap-2">
              {repo.topics.slice(0, 3).map((topic, i) => (
                <div key={i}>
                  <Badge
                    variant="secondary"
                    className="bg-cyan-100 text-cyan-800 dark:bg-teal-900/40 dark:text-teal-300 dark:border dark:border-teal-700/50"
                  >
                    {topic}
                  </Badge>
                </div>
              ...
              {repo.topics.length > 3 && (
                <Badge
                  variant="secondary"
                  className="bg-cyan-100/50 text-cyan-700 dark:bg-teal-900/20 dark:text-teal-400"
                >
                  +{repo.topics.length - 3}
                </Badge>
              )}
        ...
        <CardFooter className="flex justify-between pt-2">
          <Link
            ...
            className={cn(
              'text-cyan-500 dark:text-teal-400',
